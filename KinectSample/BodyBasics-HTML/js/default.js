            ...
            for (var bodyIndex = 0; bodyIndex < bodies.length; ++bodyIndex) {                
                ...
                if (body.isTracked) {
                    ...
                    if (bodyImageProcessor.processJointLocations(joints, jointPoints)) {
                        var jointArray = {};
                        var jointName = ["spaineBase", "SpineMid", "Neck", "Head", "ShoulderLeft", "ElbowLeft", "WristLeft", "HandLeft", "SholderRight", "ElbowRight", "WristRight", "HandRight", "HipLeft", "KneeLeft", "AnkleLeft", "FootLeft", "HipRight", "KneeRight", "AnkleRight", "FootRight", "SpineSholder", "HandTipLeft", "ThumbLeft", "HandTipRight", "ThumbRight"];
                        for (var j = 0; j < jointPoints.length; j++)
                        {
                            jointArray[jointName[j]] = jointPoint[j];
                            delete jointArray[jointNam[j]].jointType;
                        }
                        ...
                        for (var j = 0; j < jointpoints.length; j++) {
                            switch (jointPoints[j].jointType) {
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    jointArray["SholderLeft"] = jointPoints[j];
                                    break;
                                ...
                                case 8:
                                    jointArray["SholderRight"] = jointPoints[j];
                                    break;
                                ...
                                case 20:
                                    jointArray["SpineSholder"] = jointPoints[j];
                                    break;
